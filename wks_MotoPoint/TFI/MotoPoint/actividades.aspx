...
<div id="contenedorActividades">
        <div class="card-deck">
            <div class="card">
                ...
                <div class="card-body">
                    <h5 class="card-title">QUE HACER EN CHASCOMÚS</h5>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <h5 class="card-title">QUE HACER EN MAR DEL PLATA</h5>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <h5 class="card-title">QUE HACER EN CORDOBA</h5>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <h5 class="card-title">QUE HACER EN ROSARIO</h5>
                    <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This card has even longer content than the first to show that equal height action.</p>
                </div>
                <div class="card-footer">
                    <small class="text-muted">Last updated 3 mins ago</small>
